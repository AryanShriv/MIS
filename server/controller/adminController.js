...
module.exports = {
    addAdmin: async (req, res, next) => {
        try {
            ...
            else if (department === "CSDS") {
                departmentHelper = "02"
            }
            else if (department === "CS AIML") {
                departmentHelper = "03"
            }
            else {
                departmentHelper = "00"
    ...
    addStudent: async (req, res, next) => {
        try {
            ...
            const { name, email, year, fatherName, aadharCard,
                ...
                fatherMobileNumber, regNumber } = req.body;
            const student = await Student.findOne({ $or : [{email}, {registrationNumer: regNumber}] });
...
console.log("F");
            ...
            var registrationNumber = regNumber;
            console.log("FD");
