                ...
                <div className="col-md-4">
                  ...
                  <form noValidate onSubmit={formHandler}>
                    <div className="form-group">
                      <label htmlFor="branchId" style={{ fontWeight: "bold" }}>
                        Department
                      </label>
                      <select
                    ...
                    <div className="form-group">
                      <label htmlFor="yearId" style={{ fontWeight: "bold" }}>
                        Year
                      </label>
                      <select
                    ...
                    <div className="form-group">
                      <label htmlFor="sectionId" style={{ fontWeight: "bold" }}>
                        {" "}
                        Section
                      </label>
                      <select
                ...
                <div className="">
                  ...
                  <form onSubmit={secondFormHandler}>
                    <div className="form-group w-50 mx-auto">
                      <div className=" d-flex align-items-baseline">
                        ...
                        <select
                          ...
                          className="form-control p-1 m-1 w-75"
                          id="subjectId"
                        >
                          <option>Select</option>
                        ...
                        {store.faculty.fetchedStudents.map((obj, index) => (
                          <tr>
                            <td>
                              <div className="form-check">
                                <input
                                  className="form-check-input custom-chechbox"
                                  type="checkbox"
                                  value={obj._id}
                    ...
                    {!isLoading2 && (
                      <button
                        type="submit"
                        className="btn btn-outline-danger ml-1  d-block mx-auto "
                      >
                        Submit
                      </button>
                    )}
